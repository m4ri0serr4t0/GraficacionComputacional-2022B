...
pub fn plot_graph(title:&str, fname:&str, dots:&Vec<Point>, graph:&Vec<Point>) {
	...
	let drawing_area = BitMapBackend::new("/home/juanh/Descargas/b-spline/abecedario/V.png", (800, 800)).into_drawing_area();
	...
	println!("\tCreando archivo {}...", "/home/juanh/Descargas/b-spline/abecedario/V.png");
