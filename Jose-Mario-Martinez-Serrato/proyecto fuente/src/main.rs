...
fn main() {//                                                 u=2.5
    ...
    ctrl_points.push(Point::new(2.0, 4.8));
    ctrl_points.push(Point::new(3.0, 4.0));
    ctrl_points.push(Point::new(4.0, 3.0));
    ctrl_points.push(Point::new(5.0, 2.0));
    ctrl_points.push(Point::new(6.4, 0.8));
    ctrl_points.push(Point::new(6.4, 2.0));
    ctrl_points.push(Point::new(6.4, 6.1));
    ctrl_points.push(Point::new(6.0, 6.0));
    ctrl_points.push(Point::new(5.2, 3.0));
    ctrl_points.push(Point::new(3.9, 4.5));
